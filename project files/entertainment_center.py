...
# Modules used: media, fresh_tomatoes, and The Movie Database API (https://www.themoviedb.org)
...
def populate_data(movies_list):
    ...
    for m in range(len(movies_list)):
        ...
        for s in search.results:
            ...
            movies_list[m].poster_image_url = "https://image.tmdb.org/t/p/w500" + s['poster_path']
            break
